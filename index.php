...
<head>
    ...
    <link rel="shortcut icon" href="imgs/logopestaña.png">
...
<body>
                ...
                <div class="collapse navbar-collapse" id="show-menu">
                    <ul class="nav navbar-nav ">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" style="font-weight: bold; color:#01aceb !important; text-decoration: underline;" href="index.php">Home</a>
                        </li>
                        <li class="nav-item">
    ...
    <div id="home" class="slider" style="margin-top: 99px; ">
        <div id="main_slider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="imgs/6dos.jpg" alt="slider_img" />
    ...
    <div class="container" style="background-color: #f3f3f4; width: 100%; padding-bottom: 2px; margin-bottom:1px;">
        <div class="row">
            <div class="col-md-2">
    ...
    <div id="about" class="about_section layout_padding" style="padding: 10px 0 !important ;">
        <div class="container">
            <p style="color:#01aceb; font-size:25px; font-weight: 340;margin-top:1px !important;"><b>Soluciones Sostenibles en Energía - SSE</b></p>
            <div class="row">

                <div class="col-md-5">

                    <p style="font-size:35px;text-transform: none !important;"><b>Comprometidos con el Ambiente</b></p>
                    <p>
                        Aportamos soluciones consistentes en el aprovechamiento de la energía del sol, tanto para la producción de energía eléctrica, a través del efecto fotovoltaico; como para la producción de agua caliente para uso domestico o para climatización de piscinas, entre otros servicios.
                    </p>
                    <p>
                        Soluciones diseñadas para clientes residenciales, industriales o rurales. Tanto para zonas con acceso a la red eléctrica como para Zonas No Interconectadas (ZNI). Implementando proyectos con tecnologías verdes, aportando a la disminución de emisiones de Gases de Efecto Invernadero (GEI) asociadas a la generación de energía de formas convencionales.
                    </p>
                </div>
                <div class="col-md-6 offset-md-1">
                    <div class="full text_align_center">
                        <img class="img-responsive" src="imgs/ps13.gif" alt="#" />
                        <br>
                        <br>
                        <p><strong>Fotografía: <em>Pricesmart</em></strong></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="contact-form">
                        <form name="myForm" action="scripts/correo.php" method="post" onsubmit="return validateForm()">
