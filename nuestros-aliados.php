...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="show-menu">
                    <ul class="nav navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="font-weight: bold; color:#01aceb !important; text-decoration: underline; " href="nuestros-aliados.php">Nuestros Aliados</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="hiw_section layout_padding" style="background: #1a2428; margin-top: 10px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="white_font" style="margin-top: 30px;">Nuestros Aliados</h3>
                </div>
            </div>
            <div class="row">

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/sura.gif" alt="#" />
                    <h3 class="blog_head">Seguros Sura</h3>
                </div>
                ...
                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/proyecta.gif" alt="#" />
                    <h3 class="blog_head">Proyecta</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/bid.gif" alt="#" />
                    <h3 class="blog_head">Banco Interamericano de Desarrollo</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/oegreen.gif" alt="#" />
                    <h3 class="blog_head">Oegreen</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/bancoldex.gif" alt="#" />
                    <h3 class="blog_head">Bancoldex</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/apoyosyservicios.gif" alt="#" />
                    <h3 class="blog_head">Apoyos y Servicios</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/soefi.gif" alt="#" />
                    <h3 class="blog_head">Soefi</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/enermas.gif" alt="#" />
                    <h3 class="blog_head">Enermás</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/emcali.gif" alt="#" />
                    <h3 class="blog_head">Emcali</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/sol.gif" alt="#" />
                    <h3 class="blog_head">Solaire</h3>
                </div>

                <div class="col-md-4">
                    <img class="margin_top_30 img-responsive" src="imgs/prosolar.gif" alt="#" />
                    <h3 class="blog_head">ProSolar</h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="contact-form">
                        <form name="myForm" action="scripts/correoaliados.php" method="post" onsubmit="return validateForm()">
                            ...
                            ?>
                                ...
                                <script>
                                    swal("Mensaje Enviado", 'Mensaje enviado <b style="color:green;">Éxitosamente!</b>', "success").then(function() {
                                        window.location = "nuestros-aliados.php";
                                    });
                                </script>
                            <?php
                            }
