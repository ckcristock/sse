...
if ($_POST['g-recaptcha-response'] == '') {
       ...
       //$header.= "Bcc: ssegreen2020@gmail.com" . "\r\n";
       ...
       $mensajecliente .= "Página: Beneficios";
       ...
       header("Location: ../beneficios.html?correo=1");
}
?>

<!-- <script>
       window.location.href = '../beneficios.html?correo=1';
</script> -->