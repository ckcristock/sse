...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="show-menu" style="text-align: center;">
                    <ul class="nav navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" style="font-weight: bold; color:#01aceb !important; text-decoration: underline;" href="contacto.php">Contacto</a>
                        </li>
    ...
    <div style="margin: auto; display: block;   position: relative;">
        <div class="container" style="text-align: center; ">
            <h3>Soluciones Sostenibles en Energía SSE</h3>
            <h3 style="font-size:30px;">PANELES SOLARES</h3>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="contact-form">
                        <form name="myForm" action="scripts/correocontacto.php" method="post" onsubmit="return validateForm()">
